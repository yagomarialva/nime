...
define huey = Character("Aline (Hu Wei)", color="#00CED1")
...
define ex_huey = Character("Ex de Hu Wei", color="#32CD32")
...
image samantha determined = "images/characters/samantha/samantha_happy.png" if renpy.exists("images/characters/samantha/samantha_happy.png") else "images/characters/shadow.png"
image samantha laugh = "images/characters/samantha/samantha_happy.png" if renpy.exists("images/characters/samantha/samantha_happy.png") else "images/characters/shadow.png"
image samantha bikini = "images/characters/samantha/samantha_bikini.png" if renpy.exists("images/characters/samantha/samantha_bikini.png") else "images/characters/shadow.png"
...
image larissa laugh = "images/characters/larissa/larissa_happy.png" if renpy.exists("images/characters/larissa/larissa_happy.png") else "images/characters/shadow.png"
image larissa bikini = "images/characters/larissa/larissa_bikini.png" if renpy.exists("images/characters/larissa/larissa_bikini.png") else "images/characters/shadow.png"
...
image huey bikini = "images/characters/hu_wei/hu_wei_bikini.png" if renpy.exists("images/characters/hu_wei/hu_wei_bikini.png") else "images/characters/shadow.png" 
...
image camille gentle = "images/characters/camille/camille_happy.png" if renpy.exists("images/characters/camille/camille_happy.png") else "images/characters/shadow.png"
image camille bikini = "images/characters/camille/camille_bikini.png" if renpy.exists("images/characters/camille/camille_bikini.png") else "images/characters/shadow.png"
...
# Imagens para personagens ex (mapeadas para shadow já que são personagens secundários)
image ex_nicole confident = "images/characters/shadow.png"
image ex_huey confident = "images/characters/shadow.png"
image ex_camille neutral = "images/characters/shadow.png"
image ex_samantha neutral = "images/characters/shadow.png"
image ex_katia neutral = "images/characters/shadow.png"
image ex_larissa neutral = "images/characters/shadow.png"
